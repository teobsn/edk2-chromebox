...
#define FAST_BOOT_VAR_OFFSET            VAR_OFFSET (FastBoot)
#define ZERO_TIMEOUT_GRACE_PERIOD_VAR_OFFSET VAR_OFFSET (ZeroTimeoutGracePeriod)
#define SHOW_BOOT_PROMPT_VAR_OFFSET     VAR_OFFSET (ShowBootPrompt)
...
#define FAST_BOOT_QUESTION_ID            QUESTION_ID (FastBoot)
#define ZERO_TIMEOUT_GRACE_PERIOD_QUESTION_ID QUESTION_ID (ZeroTimeoutGracePeriod)
#define SHOW_BOOT_PROMPT_QUESTION_ID     QUESTION_ID (ShowBootPrompt)
